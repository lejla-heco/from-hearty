...
namespace HeartyBase.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"../Other/Datasets/indicators-of-heart-disease-319797/indicators-of-heart-disease-small.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"Smoking", @"Smoking"),new InputOutputColumnPair(@"AlcoholDrinking", @"AlcoholDrinking"),new InputOutputColumnPair(@"Stroke", @"Stroke"),new InputOutputColumnPair(@"DiffWalking", @"DiffWalking"),new InputOutputColumnPair(@"Sex", @"Sex"),new InputOutputColumnPair(@"Diabetic", @"Diabetic"),new InputOutputColumnPair(@"PhysicalActivity", @"PhysicalActivity"),new InputOutputColumnPair(@"GenHealth", @"GenHealth"),new InputOutputColumnPair(@"Asthma", @"Asthma"),new InputOutputColumnPair(@"KidneyDisease", @"KidneyDisease"),new InputOutputColumnPair(@"SkinCancer", @"SkinCancer")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
